...
3. Switch between **Month** and **Week** using the control in the calendar header.
4. Use the plus button on a calendar day, or open a day and select **Add task**.
5. Give the task a date, optional time, experiment, and notes.
6. Use a task's checkbox to mark it complete, or click the task to edit it.
7. Drag a task to another day to reschedule it.
8. Select an experiment in the sidebar to filter the calendar.
9. Click a day to open a larger view of everything scheduled for it.
